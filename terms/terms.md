...
Super 16 is licensed to You (End-User) by Dmitry Shatilov ("Licensor"), for use only under the terms of this License Agreement.
...
Super 16 when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Super 16 is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS").


#### 1. THE APPLICATION

Super 16 ("Licensed Application") is a piece of software created to help filmmakers record cinematic mobile videos — and customized for iOS mobile devices ("Devices"). It is used to record videos as 16mm cameras.
